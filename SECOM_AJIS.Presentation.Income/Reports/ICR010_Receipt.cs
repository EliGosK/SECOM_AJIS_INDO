...
namespace SECOM_AJIS.Presentation.Income.Reports {
    ...
    public class ICR010_Receipt : ReportClass {
        
        public ICR010_Receipt() {
        }
        
        public override string ResourceName {
            get {
                return "ICR010_Receipt.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "SECOM_AJIS.Presentation.Income.Reports.ICR010_Receipt.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedICR010_Receipt : Component, ICachedReport {
        
        public CachedICR010_Receipt() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            ICR010_Receipt rpt = new ICR010_Receipt();
            rpt.Site = this.Site;
            return rpt;
        }
