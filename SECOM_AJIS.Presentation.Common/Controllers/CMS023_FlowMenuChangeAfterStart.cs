...
namespace SECOM_AJIS.Presentation.Common.Controllers
{
    public partial class CommonController : BaseController
    {
        ...
        /// <returns></returns>
        public ActionResult CMS023_Authority(FlowMenuScreenParameter param)
        {
            ...
            try
            {
                ...
                if (CheckUserPermission("CMS023", FunctionID.C_FUNC_ID_OPERATE) == false)
                {
            ...
            return InitialScreenEnvironment<FlowMenuScreenParameter>("CMS023", param, res);
        }
