...
namespace SECOM_AJIS.Presentation.Common.Controllers
{
    public partial class CommonController : BaseController
    {
        ...
        /// <returns></returns>
        public ActionResult CMS024_Authority(FlowMenuScreenParameter param)
        {
            ...
            return InitialScreenEnvironment<FlowMenuScreenParameter>("CMS024", param, res);
        }
