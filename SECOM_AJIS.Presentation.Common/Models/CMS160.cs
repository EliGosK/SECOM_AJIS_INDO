...
{
    /// <summary>
    /// Screen parameter for CMS160
    /// </summary>
    public partial class CMS160_ScreenParameter : ScreenSearchParameter
    {
        //============= In parameter=============//
        [KeepSession]
    ...
    /// <summary>
    /// DO for store sale contract's detail of screen CMS160
    /// </summary>
    [Serializable]
    public class doCMS160_SaleContractDetail
    {
        public string Title { get; set; }
        public decimal? BillinAmt { get; set; }
        public decimal? NormalAmt { get; set; }
        public string txtBillinAmt { get; set; }
