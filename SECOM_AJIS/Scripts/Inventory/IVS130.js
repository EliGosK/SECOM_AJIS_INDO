...
function initScreen() {
    ...
    InstGrid = $("#InstrumentGrid").InitialGrid(0, false, "/inventory/IVS130_GetHeaderSlipDetail"); 
}
...
function initButton() {
    $("#btnRetrieve").click(function () {
        ...
        ajax_method.CallScreenController("/inventory/IVS130_RetrieveRequestInSlip", objSlipNo, function (result, controls) {
            if (controls != undefined) {
                ...
                $("#InstrumentGrid").LoadDataToGrid(InstGrid, 0, false, "/inventory/IVS130_RetrieveRequestSlipDetail", objSlipNo, "doInventorySlipDetail", false, null, null);
...
function cmdConfirm() {
    ...
    ajax_method.CallScreenController("/inventory/IVS130_cmdConfirm", obj, function (result, controls) {
        if (result != null && result != "") {
            ...
            ajax_method.CallScreenController("/Shared/GetMessage", objMsg, function (result) {
                OpenYesNoMessageDialog(result.Code, result.Message,
            function () {
                command_control.CommandControlMode(false);  
                ajax_method.CallScreenController("/inventory/IVS130_cmdConfirm_Cont", null, function (result, controls) {
                    if (result != undefined) {
