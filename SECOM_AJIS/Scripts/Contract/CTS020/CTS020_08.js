...
$(document).ready(function () {
    ...
    if (processType == 2)
        SetCTS020_08_EnableSection(false);
});
...
function InitialSiteSection() {
    if ($("#HasSiteData").val() == "True") {
        ...
        $("#rdoPurchaser").attr("disabled", true);
        ...
        $("#rdoPurchaser").removeAttr("disabled");
...
function search_site_customer_click() {
    ...
    call_ajax_method_json("/Contract/CTS020_CheckRealCustomer", obj,
...
function copy_site_information_click() {
    ...
    call_ajax_method_json("/Contract/CTS020_CopySiteInfomation", obj, function (result) {
        if (result != undefined) {
            /* --- Set Data --- */
            /* ---------------- */
...
function RetrieveSiteInformationData() {
    ...
    call_ajax_method_json("/Contract/CTS020_RetrieveSiteData", obj, function (result, controls) {
        if (controls != undefined) {
            /* --- Higlight Text --- */
            /* --------------------- */
...
function ViewSiteCustomerData(doSite, iscopy) {
    ...
    if (rdoCustomer == true)
        ...
        $("#rdoPurchaser").attr("checked", true);
    /* ---------------------------- */
}
/* ------------------------------------------------------------------------------------ */


function SetCTS020_08_SectionMode(isview) {
...
function SetCTS020_08_EnableSection(enable) {
