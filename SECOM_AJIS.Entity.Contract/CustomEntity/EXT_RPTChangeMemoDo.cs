...
{
    public partial class RPTChangeMemoDo
    {
        ...
        public string CurrencyOfNewServiceFee
        {
            get
            {
               return CommonUtil.TargetCurrency(NewContractFeeCurrencyType);
            }
        }
        ...
        public decimal ValueOfNewServiceFee
        {
            get
            {
                return CommonUtil.TargetFee(NewContractFeeCurrencyType, NewContractFee, NewContractFeeUsD);               
            }
        }
        public string CurrencyOfInstalationFee
        {
            get
            {
                return CommonUtil.TargetCurrency(OrderInstallFeeCurrencyType);
            }
        }
       
        public decimal ValueOfInstalationFee
        {
            get
            {
                return CommonUtil.TargetFee(OrderInstallFeeCurrencyType, OrderInstallFee, OrderInstallFeeUsd);
            }
        }
    }
}
