...
namespace SECOM_AJIS.Presentation.Inventory.Controllers
{
    public partial class InventoryController : BaseController
    {
        ...
        public ActionResult IVS287_Authority(IVS287_ScreenParameter param)
        {
            ...
            return InitialScreenEnvironment<IVS287_ScreenParameter>("IVS287", param, res);
        }
        ...
        /// <returns>Return ActionResult of the screen.</returns>
        [Initialize("IVS287")]
        public ActionResult IVS287()
        {
            return View();
        }

        public ActionResult IVS287_InitialSearchResultGrid()
        {
            return Json(CommonUtil.ConvertToXml<object>(null, @"Inventory\IVS287_SearchResult", CommonUtil.GRID_EMPTY_TYPE.SEARCH));
        }

        public ActionResult IVS287_SearchData(doIVS287SearchCondition searchParam)
        {
            IVS287_ScreenParameter param = GetScreenObject<IVS287_ScreenParameter>();
            ...
            try
            {
                ...
                else
                {
                    ...
                    var lst = service.GetStockReport_StockList(searchParam.ReportType, searchParam.InstrumentCode);
                    param.LastSearchParam = searchParam;
                    res.ResultData = CommonUtil.ConvertToXml(lst, @"Inventory\IVS287_SearchResult", CommonUtil.GRID_EMPTY_TYPE.VIEW);
                }
            }
            catch (Exception ex)
            {
        ...
        public ActionResult IVS287_GenerateReport(doIVS287SearchCondition reportParam)
        {
            IVS287_ScreenParameter param = GetScreenObject<IVS287_ScreenParameter>();
            ...
            try
            {
                ...
                else
                {
                    ...
                    IInventoryHandler service = ServiceContainer.GetService<IInventoryHandler>() as IInventoryHandler;
                    var lst = service.GetStockReport_StockList(param.LastSearchParam.ReportType, string.Join(",", reportParam.InstrumentCodeSelected));
                    IInventoryDocumentHandler docService = ServiceContainer.GetService<IInventoryDocumentHandler>() as IInventoryDocumentHandler;
                    param.PendingDownloadFilePath = docService.GenerateIVS287StockListReport(param.LastSearchParam.ReportType, lst);
                    param.PendingDownloadFileName = "StockListReport.xlsx";
                    res.ResultData = true;
                }
            }
            catch (Exception ex)
        ...
        public ActionResult IVS287_Download()
        {
            IVS287_ScreenParameter param = GetScreenObject<IVS287_ScreenParameter>();
