...
namespace SECOM_AJIS.Presentation.Inventory.Models
{
    ...
    /// </summary>
    public class IVS020_ScreenParameter : ScreenParameter
    {
    ...
    /// </summary>
    [MetadataType(typeof(IVS020_RegisterInstallationForStockOut_Param_Meta))]
    public class IVS020_RegisterInstallationForStockOut_Param
    {
        /// <summary>
        ...
        public List<IVS020_RegisterInstallationForStockOut_Param.doDetailParameter> details { get; set; }
        public bool? ProjectStatus { get; set; }
        public string Memo { get; set; }
        public DateTime? StockOutDate { get; set; }
    }

    public class IVS020_RegisterInstallationForStockOut_Param_Meta
    {
    ...
    /// <summary>
    /// Helper class for IVS020.
    /// </summary>
    public static class IVS020_Helper
    {
        /// <summary>
        /// Convert DO:IVS020_RegisterInstallationForStockOut_Param.doDetailParameter to DO:tbt_InventorySlipDetail
        /// </summary>
        /// <param name="lst">List of IVS020_RegisterInstallationForStockOut_Param.doDetailParameter</param>
        /// <returns>List of tbt_InventorySlipDetail</returns>
        public static List<tbt_InventorySlipDetail> ToTbt_InventorySlipDetail(this List<IVS020_RegisterInstallationForStockOut_Param.doDetailParameter> lst)
        {
        ...
        /// <summary>
        /// Convert DO:IVS020_RegisterInstallationForStockOut_Param.doDetailParameter to DO:doInstrument
        /// </summary>
        /// <param name="lst">List of IVS020_RegisterInstallationForStockOut_Param.doDetailParameter</param>
        /// <returns>List of doInstrument</returns>
        public static List<doInstrument> ToDoInstrument(this List<IVS020_RegisterInstallationForStockOut_Param.doDetailParameter> lst)
        {
