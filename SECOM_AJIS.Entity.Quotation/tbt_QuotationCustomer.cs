...
namespace SECOM_AJIS.DataEntity.Quotation
{
    public partial class tbt_QuotationCustomer
    {
        ...
        public virtual string CustPartTypeCode
        {
            get;
            set;
        }
        ...
        {
            if (previousValue != null && previousValue.tbt_QuotationCustomer.Contains(this))
            {
                previousValue.tbt_QuotationCustomer.Remove(this);
            }
    
            if (tbt_QuotationTarget != null)
            {
                if (!tbt_QuotationTarget.tbt_QuotationCustomer.Contains(this))
                {
                    tbt_QuotationTarget.tbt_QuotationCustomer.Add(this);
                }
