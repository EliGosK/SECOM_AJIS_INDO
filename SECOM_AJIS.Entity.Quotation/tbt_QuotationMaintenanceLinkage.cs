...
namespace SECOM_AJIS.DataEntity.Quotation
{
    public partial class tbt_QuotationMaintenanceLinkage
    {
        ...
        {
            if (previousValue != null && previousValue.tbt_QuotationMaintenanceLinkage.Contains(this))
            {
                previousValue.tbt_QuotationMaintenanceLinkage.Remove(this);
            }
    
            if (tbt_QuotationBasic != null)
            {
                if (!tbt_QuotationBasic.tbt_QuotationMaintenanceLinkage.Contains(this))
                {
                    tbt_QuotationBasic.tbt_QuotationMaintenanceLinkage.Add(this);
                }
