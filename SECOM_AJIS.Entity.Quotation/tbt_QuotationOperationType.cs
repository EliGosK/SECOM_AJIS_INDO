...
namespace SECOM_AJIS.DataEntity.Quotation
{
    public partial class tbt_QuotationOperationType
    {
        ...
        {
            if (previousValue != null && previousValue.tbt_QuotationOperationType.Contains(this))
            {
                previousValue.tbt_QuotationOperationType.Remove(this);
            }
    
            if (tbt_QuotationBasic != null)
            {
                if (!tbt_QuotationBasic.tbt_QuotationOperationType.Contains(this))
                {
                    tbt_QuotationBasic.tbt_QuotationOperationType.Add(this);
                }
